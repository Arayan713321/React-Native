              ...
              <>
                ...
                <View style={styles.formActions}>
                  <TouchableOpacity
                    ...
                    onPress={handleSubmit as unknown as (event: GestureResponderEvent) => void} // Cast to the correct type
                  >
...
const styles = StyleSheet.create({
  appContainer: {
    flex: 1,
    backgroundColor: '#E6E6FA', // Light purple background color for full screen
  },
  scrollContainer: {
    flexGrow: 1,
  },
